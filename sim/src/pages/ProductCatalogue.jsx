      ...
      <div className="service-content">
        <div className="service-intro">
          ...
          <p>
            ...
            throughout the lifecycle of your equipment. Our global service network ensures prompt assistance wherever you are located.
          </p>
        </div>
            ...
            <div className="service-modal" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="modal-content">
                ...
                <div className="modal-details">
                  <div className="modal-description"><p>{selectedProduct.description}</p></div>
